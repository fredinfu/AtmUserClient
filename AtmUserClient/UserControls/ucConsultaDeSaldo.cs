...
{
    public partial class ucConsultaDeSaldo : ucBase
    {
        public FileRepository fileRepository { get; set; }
        public bool download { get; private set; }
        public ucConsultaDeSaldo()
        {
            fileRepository = new FileRepository();
            InitializeComponent();
            InitializeGrid();
        }
        static ucConsultaDeSaldo _instance;

        public static ucConsultaDeSaldo Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new ucConsultaDeSaldo();
                return _instance;
            }
        }
