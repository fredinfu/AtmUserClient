...
{
    public partial class ucPagosDeProductos : ucBase
    {
        public ucPagosDeProductos()
        {
            //fileRepository = new FileRepository();
            InitializeComponent();
        }
        static ucPagosDeProductos _instance;

        public static ucPagosDeProductos Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new ucPagosDeProductos();
                return _instance;
            }
        }
