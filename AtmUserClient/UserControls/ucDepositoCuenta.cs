...
{
    public partial class ucDepositoCuenta : ucBase
    {
        public ucDepositoCuenta()
        {
            //fileRepository = new FileRepository();
            InitializeComponent();
        }
        static ucDepositoCuenta _instance;

        public static ucDepositoCuenta Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new ucDepositoCuenta();
                return _instance;
            }
        }
